...
class _$RecipeListStateImpl implements _RecipeListState {
  const _$RecipeListStateImpl({required this.isLoading});
  ...
  @override
  String toString() {
    return 'RecipeListState(isLoading: $isLoading)';
  }
...
abstract class _RecipeListState implements RecipeListState {
  const factory _RecipeListState({required final bool isLoading}) =
