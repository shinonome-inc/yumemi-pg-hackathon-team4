...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, name: $name, imageUrl: $imageUrl, profileDescription: $profileDescription, createdAt: $createdAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, imageUrl, profileDescription, createdAt);
...
abstract class _User implements User {
  const factory _User(
      ...
      required final String profileDescription,
