...
class RecipeTests(APITestCase):
    def setUp(self):
        ...
        self.recipe_data = {
            ...
            "gathering_steps": [
                {"description": "Test gathering step", "image_url": "http://example.com/gathering.jpg"}
            ],
            "cooking_steps": [
                {"description": "Test cooking step", "image_url": "http://example.com/cooking.jpg"}
            ]
        }
    ...
    def test_get_recipe(self):
        recipe = Recipe.objects.create(user=self.user, title="Test Recipe", description="Test description")
